...
game.StarterGui:SetCore(
	...
	{
		Title = "Getsuga Tensho!",
		Text = "Made By HAALFI On Discord!",
	}
)
wait(3)
...
local Window = Library:CreateWindow("Tensa Zangetsu! | Discontinued", Vector2.new(400, 400), Enum.KeyCode.V)
...
LibrarySettings:AddLabel"Script : Tensa Zangetsu!"
LibrarySettings:AddLabel"Version : Beta"

LibrarySettings:AddButton("Copy Discord Invite Link", function(IhateGayPeople)
setclipboard("https://discord.gg/moonlightlua")
game.StarterGui:SetCore(
            "SendNotification",
            {
                Title = "Tensa Zangetsu On Top",
